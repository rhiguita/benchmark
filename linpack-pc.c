/*
 * This is the modified version from http://www.netlib.org/benchmark/linpack-pc.c
 *
 * You can specify DOS option to compile using "getch()" and "_dos_getdate(..)"
 * from "conio.h".
 *
 * Tested under: 
 *  - Minix 3.2.1    - gcc 4.4.6 - Thread model: posix
